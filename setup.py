...
## Constants
CODE_DIRECTORY = 'words'
DOCS_DIRECTORY = 'docs'
TESTS_DIRECTORY = 'tests'
PYTEST_FLAGS = ['--doctest-modules','--junitxml', 'results/results.xml']
TEST_RESULTS_DIRECTORY = 'results'

# Import metadata. Normally this would just be:
#
#     from virgilio import metadata
#
# However, when we do this, we also import `virgilio/__init__.py'. If this
...
def _lint():
    ...
    retcode = subprocess.call(
        ['flake8', '--max-complexity=10', CODE_DIRECTORY])
    if retcode == 0:
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'virgilio_cli = virgilio.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'virgilio_gui = virgilio.gui:entry_point'
        # ]
    }
)
